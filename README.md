...
| 프로젝트                                                | 설명                                                     | 기간                | 참고                                       |
| --------------------------------------------------- | ------------------------------------------------------ | ----------------- | ---------------------------------------- |
| [ARM](https://github.com/2026-ARM/AI)               | 2026-1 자기주도진로설계프로젝트<br>강의안 분석 및 학습 보조 웹                | 2026.03 ~         | AI Server · FastAPI · Prompt Engineering |
| [십구만](https://github.com/2026-Quad-S-Team-10)       | 2026 GDGoC 연합 프로젝트<br>경제 초심자를 위한 뉴스 학습 웹앱              | 2026.01 ~         | Multi-Agent System · FastAPI · LLM       |
| [MAIN](https://github.com/yeverycode/MAIN)          | 2025-2 웹프로그래밍 팀프로젝트<br>학과 소개 웹사이트 리팩터링 (팀장)            | 2025.09 ~         | HTML · CSS · JavaScript                  |
...
| [오늘의 먹방은](https://github.com/yeverycode/TodayMenu)  | 숙명여자대학교 IPS 대회 동상 수상작<br>AI 기반 개인 맞춤형 메뉴 추천 시스템        | 2025.04 ~ 2025.05 | FastAPI · React · GPT API                |
...
| [손소리](https://github.com/yeverycode/HandData)       | 2025 GDGoC 연합 프로젝트<br>시각장애인을 위한 수어 인식 모델 개발 (AI 파트 담당) | 2025.01 ~ 2025.02 | OpenCV · Python · Computer Vision        |
